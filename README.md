# Jogo Ludo game
 Trabalho realizado por Gabriel Assis e Lucas vinicius em c#. Este é um projeto acadêmico desenvolvido para a criação do jogo **Ludo**. O jogo foi implementado utilizando **estruturas de dados e programação orientada a objetos**, conforme as instruções fornecidas.
 
[Acesse o PDF](Trabalho_Prático.pdf)
